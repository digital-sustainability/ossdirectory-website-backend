...
var ConfigService = /** @class */ (function () {
    ...
    ConfigService.prototype.getTranslationType = function (type) {
        console.log(type);
...
var ApolloService = /** @class */ (function () {
    ...
    ApolloService.prototype.getType = function (sequence) {
        ...
        return this.apollo.watchQuery({
            ...
            _this.config.set("type", data.Entry.__typename);
...
var uri = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].graphqlURL;
var ws_uri = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].graphqlWSURL;
...
var AddRelationshipComponent = /** @class */ (function () {
    function AddRelationshipComponent(dialog) {
        this.dialog = dialog;
...
var BadgeComponent = /** @class */ (function () {
    function BadgeComponent(config, apollo) {
        var _this = this;
        this.config = config;
        this.apollo = apollo;
        this.addNew = false;
...
var ClaimComponent = /** @class */ (function () {
    function ClaimComponent(config, apollo) {
        var _this = this;
        this.config = config;
        this.apollo = apollo;
        this.type = config.get("type");
    ...
    ClaimComponent.prototype.update = function () {
        this.apollo.sendUpdateQuery(claimUpdateQuery(this.config.getTranslationType(this.type)), { sequence: this.item.sequence, claim: this.item.claim }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
...
var ContactComponent = /** @class */ (function () {
    function ContactComponent(config, apollo) {
        this.config = config;
        this.apollo = apollo;
        this.Editor = _ckeditor_ckeditor5_build_balloon__WEBPACK_IMPORTED_MODULE_2__;
    }
    ...
    ContactComponent.prototype.updateAddress = function () {
        this.apollo.sendUpdateQuery(addressUpdateQuery(this.type), { sequence: this.item.sequence, address: this.address.address }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
    ...
    ContactComponent.prototype.updateAddress2 = function () {
        this.apollo.sendUpdateQuery(address2UpdateQuery(this.type), { sequence: this.item.sequence, address2: this.address.address2 }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
    ...
    ContactComponent.prototype.updateZip = function () {
        this.apollo.sendUpdateQuery(zipUpdateQuery(this.type), { sequence: this.item.sequence, zip: this.address.zip }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
    ...
    ContactComponent.prototype.updateCity = function () {
        this.apollo.sendUpdateQuery(cityUpdateQuery(this.type), { sequence: this.item.sequence, city: this.address.city }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
...
var DescriptionComponent = /** @class */ (function () {
    function DescriptionComponent(config, apollo) {
        this.config = config;
        this.apollo = apollo;
        this.Editor = _ckeditor_ckeditor5_build_balloon__WEBPACK_IMPORTED_MODULE_2__;
    }
    ...
    DescriptionComponent.prototype.update = function () {
        this.apollo.sendUpdateQuery(descriptionUpdateQuery(this.config.getTranslationType(this.type)), { sequence: this.item.sequence, description: this.item.description }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
...
var uploadFile = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\nmutation singleUpload($file : Upload!, $filename : String!) {\n  singleUpload(file : $file, filename : $filename) {\n    filename\n  }\n}\n"], ["\nmutation singleUpload($file : Upload!, $filename : String!) {\n  singleUpload(file : $file, filename : $filename) {\n    filename\n  }\n}\n"])));
var ImageUploaderComponent = /** @class */ (function () {
    function ImageUploaderComponent(apollo, config) {
        this.apollo = apollo;
        this.config = config;
    }
    ...
    ImageUploaderComponent.prototype.dropped = function (files) {
        var _this = this;
        if (files.length > 1) {
        ...
        if (file.fileEntry.isFile) {
            ...
            fileEntry.file(function (stream) {
                var re = /(?:\.([^.]+))?$/;
                var ending = re.exec(stream.name)[1];
                _this.apollo.uploadImage(uploadFile, {
                    file: stream,
                    filename: _this.type + "_" + _this.sequence + "." + ending
                }).subscribe();
            });
        }
    };
...
var ImageComponent = /** @class */ (function () {
    function ImageComponent(config, apollo) {
        this.config = config;
        this.apollo = apollo;
    }
    ImageComponent.prototype.ngOnInit = function () {
        ...
        obs.subscribe(function (res) {
            ...
            var re = /(?:\.([^.]+))?$/;
            var ending = re.exec(_this.item.imageUrl)[1];
            _this.item.url = "http://minio.digisus.ch/oss-directory/" + _this.type.toLowerCase() + "_" + _this.item.sequence + "." + ending;
            console.log(_this.item);
        });
    };
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this.apollo.sendQuery(listQuery(this.type), { searchString: this.searchString }).subscribe(function (result) {
            ...
            _this.items.map(function (value) {
                var ending = re.exec(value.imageUrl)[1];
                if (_this.type === _data_enums_modeltype_enum__WEBPACK_IMPORTED_MODULE_3__["Modeltype"].SuccessStory)
                    _this.type = "success_story";
                value.imageUrl = "http://minio.digisus.ch/oss-directory/" + _this.type.toLowerCase() + "_" + value.sequence + "." + ending;
            });
        });
    };
...
var TitleComponent = /** @class */ (function () {
    function TitleComponent(config, apollo) {
        var _this = this;
        this.config = config;
        this.apollo = apollo;
        this.type = config.get("type");
    ...
    TitleComponent.prototype.update = function () {
        this.apollo.sendUpdateQuery(titleUpdateQuery(this.config.getTranslationType(this.type)), { sequence: this.item.sequence, title: this.item.title }).subscribe(function (_a) {
            var data = _a.data;
            console.log(data);
        }, function (error) {
            console.log('there was an error sending the query', error);
...
var DetailComponent = /** @class */ (function () {
    function DetailComponent(apollo, config) {
        var _this = this;
        this.apollo = apollo;
        this.config = config;
...
var ClientProductRelationItemComponent = /** @class */ (function () {
    function ClientProductRelationItemComponent() {
    }
    ClientProductRelationItemComponent.prototype.ngOnInit = function () {
    };
    ...
    return ClientProductRelationItemComponent;
}());
...
var NewsFeedGridComponent = /** @class */ (function () {
    function NewsFeedGridComponent(http) {
        this.http = http;
    }
    NewsFeedGridComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiURL + 'api/get-rss-feed').subscribe(function (feed) {
            _this.newsfeed = feed;
            console.log(feed);
        });
    };
...
var SuccessStoryDetailComponent = /** @class */ (function () {
    function SuccessStoryDetailComponent() {
    }
...
var VendorClientRelationItemComponent = /** @class */ (function () {
    function VendorClientRelationItemComponent() {
    }
    VendorClientRelationItemComponent.prototype.ngOnInit = function () {
    };
    ...
    return VendorClientRelationItemComponent;
}());
...
var VendorCommunityRelationItemComponent = /** @class */ (function () {
    function VendorCommunityRelationItemComponent() {
    }
    VendorCommunityRelationItemComponent.prototype.ngOnInit = function () {
    };
    ...
    return VendorCommunityRelationItemComponent;
}());
...
var allProductsQuery = function () { return graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(templateObject_4 || (templateObject_4 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query AllProductsQuery {\n    Product(filter : {}) {\n      sequence\n      __typename\n      imageUrl\n      translation: translations(filter : {}) {\n        language(filter: {short: \"en\"}) {\n          short\n        }\n        sequence\n        __typename\n        title\n      }\n    }\n  }\n"], ["\n  query AllProductsQuery {\n    Product(filter : {}) {\n      sequence\n      __typename\n      imageUrl\n      translation: translations(filter : {}) {\n        language(filter: {short: \"en\"}) {\n          short\n        }\n        sequence\n        __typename\n        title\n      }\n    }\n  }\n"]))); };
var allSuccessStoriesQuery = function () { return graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(templateObject_5 || (templateObject_5 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query AllSuccessStoriesQuery {\n    SuccessStory(filter : {}) {\n      sequence\n      __typename\n      imageUrl\n      translation: translations(filter : {}) {\n        language(filter: {short: \"en\"}) {\n          short\n        }\n        sequence\n        __typename\n        title\n      }\n    }\n  }\n"], ["\n  query AllSuccessStoriesQuery {\n    SuccessStory(filter : {}) {\n      sequence\n      __typename\n      imageUrl\n      translation: translations(filter : {}) {\n        language(filter: {short: \"en\"}) {\n          short\n        }\n        sequence\n        __typename\n        title\n      }\n    }\n  }\n"]))); };
var VendorDetailComponent = /** @class */ (function () {
    function VendorDetailComponent(config, apollo) {
        ...
        obs.subscribe(function (res) {
            ...
            console.log(_this.successStories);
        });
        this.apollo.sendQuery(allProductsQuery()).subscribe(function (res) {
            _this.allProducts = res.data['Product'];
            console.log(_this.allProducts);
        });
        this.apollo.sendQuery(allSuccessStoriesQuery()).subscribe(function (res) {
    ...
    VendorDetailComponent.prototype.toggleAddNewSuccessStory = function () {
        this.addNewSuccessStory = !this.addNewSuccessStory;
    };
    VendorDetailComponent.prototype.toggleAddNewProdcut = function () {
        this.addNewProduct = !this.addNewProduct;
    };
    VendorDetailComponent.prototype.displayFn = function (val) {
        return val ? val.translation[0].title : val;
    };
...
var VendorProductRelationItemComponent = /** @class */ (function () {
    ...
    VendorProductRelationItemComponent.prototype.ngOnInit = function () {
        var re = /(?:\.([^.]+))?$/;
        var ending = re.exec(this.product.imageUrl)[1];
...
var VendorSuccessstoryRelationItemComponent = /** @class */ (function () {
    ...
    VendorSuccessstoryRelationItemComponent.prototype.ngOnInit = function () {
        var re = /(?:\.([^.]+))?$/;
        var ending = re.exec(this.successStory.imageUrl)[1];
