...
function createApollo(httpLink) {
    var wss = new apollo_link_ws__WEBPACK_IMPORTED_MODULE_7__["WebSocketLink"]({
        uri: ws_uri,
        options: {
            reconnect: true,
        }
    ...
    // });
    return {
        link: Object(apollo_link__WEBPACK_IMPORTED_MODULE_6__["split"])(function (_a) {
            var query = _a.query;
            var definition = Object(apollo_utilities__WEBPACK_IMPORTED_MODULE_8__["getMainDefinition"])(query);
