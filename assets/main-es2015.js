...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        this._langSub = this.langService.currentLang.subscribe(lang => {
...
const loginQuery = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a `
...
`;
const registerQuery = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a `
...
let AuthService = class AuthService {
    constructor(apollo, router, editable) {
        this.apollo = apollo;
        this.router = router;
        this.editable = editable;
    }
    login(email, password) {
        this.apollo.queryObservable(loginQuery, { email, password })
            .subscribe((res) => {
    ...
    register(email, password) {
        this.apollo.mutateObservable(registerQuery, { email, password })
            .subscribe((res) => {
...
let EditableService = class EditableService {
    constructor(config) {
        this.config = config;
    }
    isEditable() {
...
EditableService.ctorParameters = () => [
...
let FileService = class FileService {
    ...
    uploadFile(fileToUpload) {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiURL}upload`;
        ...
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => true));
    }
};
...
let RssFeedService = class RssFeedService {
    constructor(http) {
        this.http = http;
    }
    getRssFeed() {
...
const uri = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].graphqlURL;
const ws_uri = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].graphqlWSURL;
let ApolloOptionsService = class ApolloOptionsService {
    constructor(httpLink, onErrorService) {
...
ApolloOptionsService.ctorParameters = () => [
...
let OnErrorService = class OnErrorService {
    constructor() { }
    unauthorizedRetry() {
        const link = Object(apollo_link_error__WEBPACK_IMPORTED_MODULE_2__["onError"])(({ operation, graphQLErrors, networkError, response, forward }) => {
            if (graphQLErrors) {
...
let RegistrationComponent = class RegistrationComponent {
    constructor(router, apollo, auth) {
        this.router = router;
        this.apollo = apollo;
        this.auth = auth;
    }
...
let BadgeComponent = class BadgeComponent {
    constructor(config, apollo, editable) {
        this.config = config;
        this.apollo = apollo;
        this.editable = editable;
        this.addNew = false;
...
const updateImageUrl = (type) => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
let ImageUploaderComponent = class ImageUploaderComponent {
    constructor(apollo, config, file) {
        this.apollo = apollo;
        this.config = config;
        this.file = file;
    }
...
const createQuery = (type) => graphql_tag__WEBPACK_IMPORTED_MODULE_4___default.a `
...
let CreateNewComponent = class CreateNewComponent {
    constructor(config, apollo, router) {
        this.config = config;
        this.apollo = apollo;
        this.router = router;
    }
...
CreateNewComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_2__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_3__["ApolloService"] },
...
const CreateQuery = (type) => graphql_tag__WEBPACK_IMPORTED_MODULE_6___default.a `  mutation createModel{
    Create${type} {
        sequence
    }
}
...
let DetailComponent = class DetailComponent {
    constructor(apollo, config, route) {
        this.apollo = apollo;
        this.config = config;
        this.route = route;
    ...
    ngOnInit() {
        ...
        const subs = events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.terminateSubs)).subscribe(() => {
            subs.unsubscribe();
            this.ngOnInit();
        });
    }
...
const clientQuery = (type, sequence) => graphql_tag__WEBPACK_IMPORTED_MODULE_5___default.a `
  query ClientQuery {
...
`;
const clientSuccessStoryUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_5___default.a `
...
let ClientDetailComponent = class ClientDetailComponent {
    ...
    addSuccessStory(successStory) {
        this.apollo.sendUpdateQuery(clientSuccessStoryUpdateQuery(), { sequence: this.sequence, successstory_sequence: successStory.sequence }, clientQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
...
`;
let ClientSuccessstoryRelationCreateItemComponent = class ClientSuccessstoryRelationCreateItemComponent {
...
ClientSuccessstoryRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
...
let ClientSuccessstoryRelationItemComponent = class ClientSuccessstoryRelationItemComponent {
    constructor() { }
    ngOnInit() {
        const re = /(?:\.([^.]+))?$/;
...
const productQuery = (type, sequence) => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
  query ProductQuery {
...
`;
const productSuccessStoryUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
const productVendorUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
let ProductDetailComponent = class ProductDetailComponent {
    ...
    addSuccessStory(successStory) {
        this.apollo.sendUpdateQuery(productSuccessStoryUpdateQuery(), { sequence: this.sequence, successstory_sequence: successStory.sequence }, productQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
    ...
    addVendor(vendor) {
        this.apollo.sendUpdateQuery(productVendorUpdateQuery(), { sequence: this.sequence, vendor_sequence: vendor.sequence }, productQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
...
`;
let ProductSuccessstoryRelationCreateItemComponent = class ProductSuccessstoryRelationCreateItemComponent {
    constructor(config, apollo, dialogRef, data) {
        this.config = config;
        this.apollo = apollo;
        this.dialogRef = dialogRef;
...
ProductSuccessstoryRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
...
let ProductSuccessstoryRelationItemComponent = class ProductSuccessstoryRelationItemComponent {
    constructor() { }
    ngOnInit() {
        const re = /(?:\.([^.]+))?$/;
        const ending = re.exec(this.successStory.logo)[1];
...
const allVendorsQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
let ProductVendorRelationCreateItemComponent = class ProductVendorRelationCreateItemComponent {
    constructor(config, apollo, dialogRef, data) {
        this.config = config;
        this.apollo = apollo;
        this.dialogRef = dialogRef;
...
ProductVendorRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
...
let ProductVendorRelationItemComponent = class ProductVendorRelationItemComponent {
    constructor() { }
    ngOnInit() {
        const re = /(?:\.([^.]+))?$/;
...
const successStoryQuery = (type, sequence) => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
const successStoryProductUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
const successStoryClientUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
const successStoryVendorUpdateQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
let SuccessStoryDetailComponent = class SuccessStoryDetailComponent {
    ...
    addVendor(vendor) {
        this.apollo.sendUpdateQuery(successStoryVendorUpdateQuery(), { sequence: this.sequence, vendor_sequence: vendor.sequence }, successStoryQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
    ...
    addClient(client) {
        this.apollo.sendUpdateQuery(successStoryClientUpdateQuery(), { sequence: this.sequence, client_sequence: client.sequence }, successStoryQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
    ...
    addProduct(product) {
        this.apollo.sendUpdateQuery(successStoryProductUpdateQuery(), { sequence: this.sequence, product_sequence: product.sequence }, successStoryQuery(this.type, this.sequence)).subscribe(({ data }) => {
            console.log(data);
        }, (error) => {
            console.log('there was an error sending the query', error);
        });
...
SuccessStoryDetailComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] }
];
...
const allClientsQuery = () => graphql_tag__WEBPACK_IMPORTED_MODULE_2___default.a `
...
`;
let SuccessstoryClientRelationCreateItemComponent = class SuccessstoryClientRelationCreateItemComponent {
    constructor(config, apollo, dialogRef, data) {
        this.config = config;
        this.apollo = apollo;
        this.dialogRef = dialogRef;
...
SuccessstoryClientRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
...
`;
let SuccessstoryProductRelationCreateItemComponent = class SuccessstoryProductRelationCreateItemComponent {
    constructor(config, apollo, dialogRef, data) {
        this.config = config;
        this.apollo = apollo;
        this.dialogRef = dialogRef;
...
SuccessstoryProductRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
...
let SuccessstoryProductRelationItemComponent = class SuccessstoryProductRelationItemComponent {
    ...
    ngOnInit() {
        const re = /(?:\.([^.]+))?$/;
        const ending = re.exec(this.product.logo)[1];
...
`;
let SuccessstoryVendorRelationCreateItemComponent = class SuccessstoryVendorRelationCreateItemComponent {
    constructor(config, apollo, dialogRef, data) {
        this.config = config;
        this.apollo = apollo;
        this.dialogRef = dialogRef;
...
SuccessstoryVendorRelationCreateItemComponent.ctorParameters = () => [
    { type: _config_services_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] },
    { type: _data_services_apollo_service__WEBPACK_IMPORTED_MODULE_4__["ApolloService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialogRef"] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_5__["MAT_DIALOG_DATA"],] }] }
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm2015/ngx-translate-core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! @ngx-translate/http-loader */ "./node_modules/@ngx-translate/http-loader/fesm2015/ngx-translate-http-loader.js");
